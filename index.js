...
const PRODUCTS = [
  { name: "Derol ტუში",        price: 19, keys: ["ტუში", "tushi", "mascara", "derol tushi"] },
  { name: "Derol ტონალური",    price: 35, keys: ["ტონალური", "tonaluri", "foundation", "სტიქი"] },
  { name: "Derol წარბის გელი", price: 35, keys: ["წარბის", "warbis", "გელი", "fixer", "fixatori"] },
  { name: "Soft Skin ხელთათმანი", price: 29, keys: ["ხელთათმანი", "softskin", "soft skin", "პილინგი"] },
...
1. Derol ტუში — 19 ₾
   წყალგამძლე, 24 საათი გძლება. 3D მოცულობა და სიგრძე ერთი დაწვით.
   ჰიპოალერგიული, ჭარბი თვალებისა და კონტაქტური ლინზების მომხმარებლებისთვისაც.

2. Derol ტონალური სტიქი (Foundation Stick) — 35 ₾ (2 ცალი 60 ₾)
   მძლავრი დაფარვა, ბუნებრივი მატ ეფექტი. ჩაშენებული ჯაგრისი.
   წყლისა და ოფლის გამძლე. გამოიყენება ტონალურად, კონტურინგად ან ჰაილაიტერად.

3. Derol წარბის გელი (Fixer) — 35 ₾
   მთელი დღე ინარჩუნებს წარბების ფორმას. გამჭვირვალე, სწრაფმშრალი, წყალგამძლე.
   3D ეფექტი, ყველა ტიპის წარბისთვის. ჰიპოალერგიული.

4. Soft Skin ხელთათმანი (პილინგის ხელთათმანი) — 29 ₾
   სპა-დონის პილინგი სახლში. ეფექტი პირველივე გამოყენებიდან.
   ამოიღებს მკვდარ კანს, ამცირებს ცელულიტს, აუმჯობესებს სისხლის მიმოქცევას,
   შლის ჩაზრდილ თმებს. კვირაში მაქსიმუმ 2-ჯერ. ხელმისაწვდომია მწვანე და ვარდისფერ ფერში.
   გამოყენება: ცხელი წყლით 5-10 წუთი დარბილება → ხელთათმანის დასველება → წრიული მოძრაობები.

5. Maffick ქონსილერი — 29 ₾
   მსუბუქი, ბუნებრივი გამოჩენა. ანიჟებს ბნელ წრეებს, სიწითლეს, პრობლემურ ადგილებს.
   ჰიპოალერგიული, აკნეს საწინააღმდეგო. ყველა ტიპის კანისთვის, მათ შორის მგრძნობიარე.
   ამცირებს სიმშრალეს, ახანგრძლივებს მაკიაჟს. ყველა ტონისთვის.

🚚 მიწოდება და გადახდა:
- თბილისი: უფასო მიწოდება, მეორე დღეს.
- რეგიონები: +7 ₾, 2–3 სამუშაო დღეში, ყველა ქალაქში.
- გადახდა: ადგილზე, კურიერთან.

🎯 მთავარი მიზანი — შეკვეთის გაფორმება. საჭიროა:
1. პროდუქტი და რაოდენობა
2. სახელი
3. ტელეფონის ნომერი
